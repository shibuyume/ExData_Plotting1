...
#draw voltage line chart
with(barchartds, plot(DateTime, Voltage, type = "l", xlab = "datetime"))

#draw global active power 
with(barchartds, plot(DateTime, Global_reactive_power, xlab = "datetime", type = "l"))
